...
public class Plane {
    ...
    public Plane(float[] center) {

        //move the center of the plane to the specified location
        for (int j = 0; j < 6; j++) {
            planePositionData[3 * j] = planePositionData[3 * j] + center[0];
            planePositionData[3 * j + 1] = planePositionData[3 * j + 1] + center[1];
            planePositionData[3 * j + 2] = planePositionData[3 * j + 2] + center[2];
        }
