...
public class SceneRenderer implements GLSurfaceView.Renderer {
    ...
    private final Activity mShadowsActivity;

    private FPSCounter mFPSCounter;

    /**
     * Bigger shadow map texture results to better shadow edges, cap it between 1.0 and 2.0
     * is the best since it won't slow down too much but still have good shadow resolution.
     * Shadow map size:
     * width = displayWidth * SHADOW_MAP_RATIO
     * height = displayHeight * SHADOW_MAP_RATIO
     */
    private float mShadowMapRatio = 1.0f;

    public void setShadowMapRatio(float mShadowMapRatio) {
    ...
    public void setBiasType(float mBiasType) {
